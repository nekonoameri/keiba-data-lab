...
def main():
    ap=argparse.ArgumentParser(); ap.add_argument('--year',type=int,default=2026); ap.add_argument('--years',default='',help='comma-separated years, e.g. 2024,2025,2026'); ap.add_argument('--fetch',action='store_true'); ap.add_argument('--limit',type=int,default=0); ap.add_argument('--result-urls',default=''); ap.add_argument('--base-url',default=''); a=ap.parse_args()
